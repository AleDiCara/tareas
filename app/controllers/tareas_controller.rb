class TareasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tarea.save
        format.html { redirect_to @tarea, notice: 'La tarea ha sido creada.' }
  ...
  def update
    ...
    respond_to do |format|
      if @tarea.update_attributes(params[:tarea])
        format.html { redirect_to @tarea, notice: 'La tarea ha sido actualizada.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tareas_url, notice: 'push' }
      format.json { head :no_content }
    end
  end
end
